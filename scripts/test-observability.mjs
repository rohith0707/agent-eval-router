...
try {
  if (process.platform === "win32") {
    execSync(`npx.cmd tsc lib/observability.ts --target ES2022 --module commonjs --moduleResolution node --skipLibCheck --outDir "${outDir}"`, { stdio: "inherit" });
  } else {
    execFileSync("npx", ["tsc", "lib/observability.ts", "--target", "ES2022", "--module", "commonjs", "--moduleResolution", "node", "--skipLibCheck", "--outDir", outDir], { stdio: "inherit" });
  }
